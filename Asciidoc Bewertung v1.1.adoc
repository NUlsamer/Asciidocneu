...
Hierzu haben wir uns mit der Syntax, verschiedenen Asciidoc Editoren, der Konvertierung von adoc in andere Formate beschäftigt und einen direkten Vergleich zu dem gängigen Programm Microsoft Office Word 2010 gezogen.
